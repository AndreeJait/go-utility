...
// MockDBITx is an autogenerated mock type for the DBITx type
type MockDBITx struct {
	mock.Mock
}

// Begin provides a mock function with given fields: ctx
func (_m *MockDBITx) Begin(ctx context.Context) (pgx.Tx, error) {
	ret := _m.Called(ctx)
...
func (_m *MockDBITx) Commit(ctx context.Context) error {
	ret := _m.Called(ctx)
...
func (_m *MockDBITx) Conn() *pgx.Conn {
	ret := _m.Called()
...
func (_m *MockDBITx) CopyFrom(ctx context.Context, tableName pgx.Identifier, columnNames []string, rowSrc pgx.CopyFromSource) (int64, error) {
...
func (_m *MockDBITx) Exec(ctx context.Context, sql string, arguments ...interface{}) (pgconn.CommandTag, error) {
	var _ca []interface{}
...
func (_m *MockDBITx) LargeObjects() pgx.LargeObjects {
	ret := _m.Called()
...
func (_m *MockDBITx) Prepare(ctx context.Context, name string, sql string) (*pgconn.StatementDescription, error) {
...
func (_m *MockDBITx) Query(ctx context.Context, sql string, args ...interface{}) (pgx.Rows, error) {
	var _ca []interface{}
	_ca = append(_ca, ctx, sql)
	_ca = append(_ca, args...)
	ret := _m.Called(_ca...)
...
func (_m *MockDBITx) QueryRow(ctx context.Context, sql string, args ...interface{}) pgx.Row {
	var _ca []interface{}
	_ca = append(_ca, ctx, sql)
	_ca = append(_ca, args...)
	ret := _m.Called(_ca...)
...
func (_m *MockDBITx) Rollback(ctx context.Context) error {
	ret := _m.Called(ctx)
...
func (_m *MockDBITx) SendBatch(ctx context.Context, b *pgx.Batch) pgx.BatchResults {
	ret := _m.Called(ctx, b)
...
// NewMockDBITx creates a new instance of MockDBITx. It also registers a testing interface on the mock and a cleanup function to assert the mocks expectations.
// The first argument is typically a *testing.T value.
func NewMockDBITx(t interface {
	mock.TestingT
	Cleanup(func())
}) *MockDBITx {
	mock := &MockDBITx{}
